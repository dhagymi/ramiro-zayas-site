...
export default class Options extends Component {
  ...
  create() {
    ...
    this.socialMediaQuantity = this.generalComponents?.listItems?.length / 2;
        ...
        (item, index) => {
          if (index < this.socialMediaQuantity) {
            return new HideHover({
              element: `.social__list__item:nth-child(${index + 1})`,
              generalComponents: {
                toHover: this.generalSelectors.musicCardNext,
              },
            });
          }
        }
